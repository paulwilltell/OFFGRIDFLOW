        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="space-y-10 text-gray-300 leading-relaxed">
            ...
            <section className="rounded-2xl border border-gray-800 bg-gray-800/20 p-6">
              <h2 className="text-xl font-semibold text-white">More on our posture</h2>
              <p className="mt-2 text-sm text-gray-400">
                For our full security and privacy commitments, see the Trust Center.
              </p>
              <div className="mt-4">
                <Link href="/trust" className="inline-block rounded-xl border border-gray-800/70 bg-gray-900/40 p-4 text-sm text-white transition hover:border-primary-600/40">
                  Trust center →
                </Link>
              </div>
            </section>
